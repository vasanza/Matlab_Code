function [trainedModel, validationRMSE] = trainRegressionModel_1hour(trainingData, responseData)
...
% Auto-generated by MATLAB on 05-Aug-2021 12:57:44
...
concatenatedPredictorsAndResponse.output = response;
linearModel = fitlm(...
...
for fold = 1:KFolds
    ...
    concatenatedPredictorsAndResponse.output = trainingResponse;
    linearModel = fitlm(...
        concatenatedPredictorsAndResponse, ...
        'linear', ...
        'RobustOpts', 'on');
